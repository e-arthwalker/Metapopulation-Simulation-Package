...
choose.alphas<-function(nndists.distribution, landscape.limit){
  a.4min<-nndists.distribution[1]/4 #average dispersal distance 4x smaller than min(min) nndist 
  a.2min<-nndists.distribution[1]/2 #average dispersal distance 2x smaller than min(min) nndist
  a.minmin<-nndists.distribution[1] #average dispersal distance = the min(min) nndist
  minmin.a.min<-nndists.distribution[1]+((nndists.distribution[2]-nndists.distribution[1])/2) #min(min) nndist < average dispersal distance < mean(min) nndist
